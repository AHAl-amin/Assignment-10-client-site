...
// ......................
    ...
    const navlinks = <>
        ...
        <li><NavLink to="/alltourist" className='font-semibold'> All Tourists Spot</NavLink></li>
        {
            user && <>


                <li><NavLink to="/addtourist" className='font-semibold'> Add Tourists Spot</NavLink></li>
                <li><NavLink to="/mylist" className='font-semibold'> My List </NavLink></li>
            </>
        }
    ...
    return (
        <div className="navbar bg-base-100 max-w-6xl mx-auto">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost md:text-3xl text-[16px] font-bold" >Love to <span className="text-red-500">travel</span></a>
